...
# Import the fresh_tomatoes file because you will call its function open_movies_page
import media
...
# Call the fresh_tomatoes.py file in order to create the HTML page
# and call the function open_movies_page and pass in the array 'movies' as argument
